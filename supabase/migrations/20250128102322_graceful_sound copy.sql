-- First ensure we clean up any duplicate data
DELETE FROM post_categories
WHERE post_id IN (
  SELECT id FROM posts WHERE slug = 'husson-university-eagles-partnership'
);

DELETE FROM posts 
WHERE slug = 'husson-university-eagles-partnership';

DELETE FROM organizations 
WHERE slug = 'husson-athletics';

-- Now add the data fresh
...
SELECT new_post.id, categories.id
FROM new_post
