-- Add import_identifier column to posts table if it doesn't exist
ALTER TABLE posts
ADD COLUMN IF NOT EXISTS import_identifier text;

-- Add index for faster deletion queries
CREATE INDEX IF NOT EXISTS idx_posts_import_identifier ON posts(import_identifier);
