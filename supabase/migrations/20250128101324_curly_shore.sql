-- Add Husson University to organizations if not exists
INSERT INTO organizations (name, slug, website_url, description)
SELECT 'Husson University Athletics', 'husson-athletics', 'https://hussoneagles.com', 'NCAA Division III athletics program at Husson University, featuring 22 varsity sports teams and over 500 student-athletes.'
WHERE NOT EXISTS (
  SELECT 1 FROM organizations WHERE slug = 'husson-athletics'
);
