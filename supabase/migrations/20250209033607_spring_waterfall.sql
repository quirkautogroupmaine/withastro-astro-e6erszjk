-- Update function to format IYC post for Meilisearch
...
-- Update function to sync IYC post to Meilisearch
  ...
  CASE TG_OP
    ...
    WHEN 'UPDATE' THEN
      ...
      ELSE
        ...
        endpoint := meilisearch_host || '/indexes/iyc/documents/' || NEW.id;
